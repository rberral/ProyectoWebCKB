...
public final class CellDepConcrete extends Struct {
  ...
  public static final class Builder {
    ...
    private Builder(@Nonnull byte[] buf) {
      ...
      if (buf.length != SIZE) {
        throw MoleculeException.invalidByteSize(SIZE, buf.length, CellDepConcrete.class);
      }
      byte[] itemBuf;
    ...
    public CellDepConcrete build() {
      ...
      CellDepConcrete s = new CellDepConcrete();
      s.buf = buf;
      s.outPoint = outPoint;
      s.depType = depType;
      return s;
