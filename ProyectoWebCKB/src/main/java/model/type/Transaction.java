...
import model.Blake2b;
import model.type.RawTransaction;

import static model.MoleculeConverter.packBytesVec;
...
public class Transaction {
  ...
  public model.Transaction pack() {
    return model.Transaction.builder()
