...
public class MoleculeConverter {
  ...
  public static CellInputVec packCellInputVec(List<model.type.CellInput> in) {
  ...
  public static CellOutputVec packCellOutputVec(List<model.type.CellOutput> in) {
  ...
  public static CellDepVec packCellDepVec(List<model.type.CellDep> in) {
  ...
  public static TransactionVec packTransactionVec(List<model.type.Transaction> transactions) {
    TransactionVec.Builder builder = TransactionVec.builder();
    Transaction[] packed_transactions = transactions.stream().map(model.type.Transaction::pack).toArray(Transaction[]::new);
  ...
  public static UncleBlock packUncleBlock(model.type.Block.Uncle uncle) {
  ...
  public static UncleBlockVec packUncleBlockVec(List<model.type.Block.Uncle> uncles) {
